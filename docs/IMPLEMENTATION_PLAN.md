...
member's name and email~~ — closed by `AUTH-2` in slice 2b-ii, 2026-09-20.** It was equally true before that slice, so it was not a regression, but `AUTH-2`
