...
export default function ContactPage() {
  return (
    <section className={`${shell} grid gap-[var(--sp-16)] py-[var(--sp-16)] lg:grid-cols-[4fr_5fr] lg:py-[var(--sp-24)]`}>
      <div>
        <h1 className="max-w-[14ch] text-[clamp(2.25rem,5vw,var(--fs-display))] font-semibold leading-[1.05] tracking-[-0.03em] text-fg">
          Ask about a place.
        </h1>
        <p className="mt-[var(--sp-6)] max-w-[46ch] text-[var(--fs-lead)] leading-[var(--lh-loose)] text-fg-2">
        ...
        <div className="mt-[var(--sp-12)] flex flex-col gap-[var(--sp-4)] border-t border-[var(--border-light)] pt-[var(--sp-8)]">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-[var(--sp-3)] text-[var(--fs-body)] text-fg-2 transition-colors duration-[var(--dur-fast)] hover:text-fg"
          >
