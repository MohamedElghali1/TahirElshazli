...
-- `returned_at` (migration 019): migrations run BEFORE seeds, so 019's backfill
-- never sees these rows. Every corrected fixture is returned - exactly what a
-- mark meant before the save/return split - and the unmarked sub-2 is not.
INSERT INTO assessment_submissions (id, assessment_id, student_id, file_url, answer_text, submitted_at, last_submitted_at, updated_at, score, corrected_at, feedback, annotated_file_url, returned_at) VALUES
  ('sub-1', 'assess-3', 'student-1', 'https://storage.example.com/submissions/midterm.pdf',      NULL, '2026-08-20T15:30:00Z', '2026-08-20T15:30:00Z', '2026-08-20T15:30:00Z',   35, '2026-08-22T10:00:00Z', 'Strong titration work. Watch significant figures in part 3.',      'https://storage.example.com/annotated/midterm-corrected.pdf', '2026-08-22T10:00:00Z'),
  ('sub-2', 'assess-4', 'student-1', 'https://storage.example.com/submissions/moles-hw.pdf',     NULL, '2026-08-24T19:10:00Z', '2026-08-24T19:10:00Z', '2026-08-24T19:10:00Z', NULL, NULL,                   NULL,                                                               NULL, NULL),
  ('sub-3', 'assess-5', 'student-1', 'https://storage.example.com/submissions/nomenclature.pdf', NULL, '2026-07-12T14:00:00Z', '2026-07-12T14:00:00Z', '2026-07-12T14:00:00Z',   18, '2026-07-15T09:00:00Z', 'Excellent. Only slipped on the halogenoalkane ordering.',           NULL, '2026-07-15T09:00:00Z'),
  ('sub-4', 'assess-6', 'student-1', 'https://storage.example.com/submissions/energetics.pdf',   NULL, '2026-06-22T20:00:00Z', '2026-06-22T20:00:00Z', '2026-06-22T20:00:00Z',   12, '2026-06-25T11:00:00Z', 'Revise Hess cycles and the effect of temperature on rate.',         NULL, '2026-06-25T11:00:00Z'),
  ('sub-5', 'assess-7', 'student-1', 'https://storage.example.com/submissions/synthesis.pdf',    NULL, '2026-08-08T17:45:00Z', '2026-08-08T17:45:00Z', '2026-08-08T17:45:00Z',   34, '2026-08-12T13:00:00Z', 'Good routes. Justify reagent choice more explicitly next time.',    NULL, '2026-08-12T13:00:00Z'),
  ('sub-6', 'assess-8', 'student-1', 'https://storage.example.com/submissions/atomic-hw.pdf',    NULL, '2026-05-18T16:20:00Z', '2026-05-18T16:20:00Z', '2026-05-18T16:20:00Z',   16, '2026-05-21T10:30:00Z', 'Solid, but check your mass spectrometry interpretation.',           NULL, '2026-05-21T10:30:00Z')
ON CONFLICT (id) DO NOTHING;
